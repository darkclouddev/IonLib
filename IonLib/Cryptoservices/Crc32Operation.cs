...
namespace IonLib.Cryptoservices
{
	public class Crc32Operation
	{
		...
		protected static void CRC32Init()
		{
		...
		protected static UInt32 CRC32Update(UInt32 crc, byte c)
		{
			uint longC = 0x000000ff & (UInt32)c;
		...
		{
			return ComputeCRC16IBM(data, (UInt16)data.Length);
		}
		public static UInt16 ComputeCRC16IBM(byte[] data, UInt16 length)
		{
			UInt16[] crcTable =
			{
			...
			{
				x = (UInt16)(crc ^ data[i]);
				crc = (UInt16)((crc >> 8) ^ crcTable[x & 0x00FF]);
			}
